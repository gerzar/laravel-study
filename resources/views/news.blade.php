...
@section('content')
    ...
    <ul>
        <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus esse et ipsam iusto pariatur perferendis
            provident quam repellat sequi voluptatum!
        </li>
        <li>Adipisci alias aut et fuga inventore labore laboriosam officiis quas temporibus? Earum ipsum iusto minima
            nihil repellendus reprehenderit suscipit vel!
        </li>
